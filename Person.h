#ifndef PARIRU_PERSON_H
#define PARIRU_PERSON_H
...
public:
    ...
    virtual void setFullName(std::string m_fullname) { fullname = m_fullname; }
    virtual void setHeight(int m_height) { height = m_height; }
    virtual void setWeight(int m_weight) { weight = m_weight; }
    virtual void setGender(std::string m_gender) { gender = m_gender; }
    virtual void setCountry(std::string m_country) { country = m_country; }
    virtual void setEmail(std::string m_email) { email = m_email; }
